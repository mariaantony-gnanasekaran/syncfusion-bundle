/* */ 
define(['exports', '../common/widget-base', '../common/constants', '../common/decorators', '../common/common', 'syncfusion-javascript/Scripts/ej/web/ej.tab.min'], function (exports, _widgetBase, _constants, _decorators, _common) {
  'use strict';
