/* */ 
define(['exports', '../common/widget-base', '../common/constants', '../common/decorators', '../common/common', '../common/template-processor', 'syncfusion-javascript/Scripts/ej/web/ej.grid.min'], function (exports, _widgetBase, _constants, _decorators, _common, _templateProcessor) {
  'use strict';
